/**
 * Pure helpers behind the platform marks: the short-name resolver, the logo URL
 * resolver, and the brand-colour lookup.
 *
 * They live apart from PlatformLogo.jsx because a module that exports both
 * components and plain functions loses fast refresh. Nothing here touches React
 * or the DOM, which is also what makes it testable on its own.
 */
